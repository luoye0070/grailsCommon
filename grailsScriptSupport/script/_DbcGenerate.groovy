...
import com.lj.generator.dbc.DbcGenerator
...
def generateForDomainClass(domainClass) {
    def templateGenerator = new DbcGenerator(classLoader)
    ...
    if (generateController) {
        ...
        templateGenerator.generateController(domainClass, basedir,apppkg)
